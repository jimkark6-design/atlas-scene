...
export async function POST(
  ...
  try {
    ...
    for (
      ...
      const timestamps = [
        Math.max(0.08, duration * 0.10),
        Math.max(0.08, duration * 0.25),
        Math.max(0.08, duration * 0.40),
        Math.max(0.08, duration * 0.55),
        Math.max(0.08, duration * 0.70),
        Math.max(0.08, duration * 0.90),
      ];
